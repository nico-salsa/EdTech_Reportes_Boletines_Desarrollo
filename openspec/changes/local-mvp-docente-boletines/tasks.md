...
- [ ] 7.1 Crear pruebas unitarias y de integracion para autenticacion, cursos, programa y notas
- [ ] 7.2 Crear escenarios funcionales con SerenityBDD + Cucumber para los flujos principales del MVP
- [ ] 7.3 Crear pruebas de API con Karate para registro, login, cursos, estudiantes, programa, notas y exportacion
- [ ] 7.4 Crear base de pruebas de rendimiento con k6 para endpoints criticos del MVP

## 8. Cierre tecnico del MVP

- [x] 8.1 Revisar consistencia de contratos entre backend y frontend del MVP
- [x] 8.2 Documentar scripts de ejecucion local para `frontend/` y `backend/`
- [ ] 8.3 Ejecutar validaciones finales del cambio y preparar el siguiente paso de implementacion con `/opsx:apply`
