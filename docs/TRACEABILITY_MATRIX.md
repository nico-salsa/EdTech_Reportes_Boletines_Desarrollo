...
| Runtime local | `local-runtime-baseline` | `backend/build.gradle.kts`, `frontend/package.json`, `docs/EJECUCION_LOCAL.md` | `.\gradlew.bat test` y `pnpm --dir frontend build` exitosos |
...
| Quality gates | `quality-gates` | `openspec/changes/asdd-local-functional-realignment/tasks.md` | Parcial: validaciones minimas documentadas, CI aun pendiente |
