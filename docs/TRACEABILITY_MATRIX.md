...
| Quality gates | `quality-gates` | `.github/workflows/ci.yml`, `backend/build.gradle.kts`, `docs/MERGE_CHECKLIST.md` | Integracion en PR contra `main` con jobs separados para OpenSpec, frontend y backend; backend validado con `build` y cobertura >= 80% |
